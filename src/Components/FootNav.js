  ...
  return (
    <BottomNavigation
      ...
      onChange={(event, newValue) => {
        ...
        //setValue(newValue);
        //setting prompt value, second has function of setting. same as use state, when u set u have first value, second setValue
        //  otherwise prompt.screenconfig kerna hoa hai.
